...
def classify(text: str, has_media: bool = False, msg_type: str = "text") -> tuple:
    ...
    if any(k in txt for k in ["customs","import","clearance","regulatory","approval","moh","dha","custom","duty"]):
    ...
    if any(k in txt for k in ["cold chain","biologic","glp","insulin","ozempic","mounjaro","refrigerat","dupixent","humira","wegovy","saxenda","noveltreat","semaglutide","tirzepatide"]):
