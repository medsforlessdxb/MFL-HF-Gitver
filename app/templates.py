...
"payment": """Thank you for your payment question. We accept bank transfer, credit/debit card, and UPI. All prices are quoted in INR.

Full payment is required in advance before we procure your medicines. We do not offer cash on delivery, because medicines are procured specifically for your order.

If you have already paid or have a payment issue, please share your order reference (like MFL-XXXXXXXX) and our team will confirm as soon as possible.""",
...
"otc_supplement": """Yes, we can source supplements and over-the-counter products from India for you.

To prepare a quote, could you share:
- The product name and strength
- How many you need
- Where we should deliver

For some supplements the shipping cost can make local purchase cheaper, so our quote will show the full pricing and we can compare it with the local price if you like. That way you can decide what works best.""",
...
"order_status": """Thank you for checking on your order. I have escalated this as high priority to our team.

Someone will get back to you as soon as possible with an update. If you have a reference number like MFL-XXXXXXXX, please share it to help us locate your order quickly.""",

"complaint_return": """I am sorry to hear about this issue. I have escalated this as a priority to our team.

For damaged or wrong medicine, please do not use it. Keep the packaging and take photos for verification. If you feel unwell, please seek medical attention first.

Could you share your order reference and a brief description of the issue? Our team will get back to you as soon as possible.""",

"privacy_data": """Thank you for your privacy question. Your prescription and personal information are handled securely and used only to process your order. We share prescription details only with the licensed pharmacy partner fulfilling your order.

You can read our full privacy policy here:
https://medsforlessdxb.github.io/MFL-HF-Gitver/privacy.html

If you would like your data deleted or have a specific request, reply here and our team will handle it.""",
...
"medical_device_alt": """Yes, we can source medical devices (like BP monitors and glucometers) as well as homeopathic, Ayurvedic, and Unani medicines from India.

Please share the product name (and potency or model if you know it), quantity, and delivery destination. Our team will check availability and prepare a quote. Service fees for devices and alternative medicines may differ slightly from prescription medicines.

Which product are you looking for?""",

"cancel_order": """Our cancellation policy: free cancellation within 24 hours if your medicines have not yet been procured. After procurement, a 15% restocking fee applies. Orders cannot be cancelled once dispatched.

If you would like to cancel an order, please share your order reference (like MFL-XXXXXXXX) and our team will process it as a priority.""",

"human_request": """Of course. I have asked our team to get in touch with you personally. Someone will reply here as soon as possible.

To help them, could you share what you need help with, for example the medicine name or your order reference?""",

"acknowledgement": """You're welcome! If you need anything else, just send the medicine name or a photo of your prescription.""",

"resubscribe": """Welcome back! You are subscribed again and will receive messages from Meds For Less.
...
"adverse_reaction": """I am very sorry to hear this. Please seek medical attention now from your doctor or local emergency service. If this started after taking a medicine, stop taking it until a doctor advises you. If you have difficulty breathing, chest pain, or swelling of the face or throat, call emergency services immediately.

I have escalated this as URGENT to our team. Please keep any medicine packaging for review.
